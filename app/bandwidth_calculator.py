...
def probability_success(failure_when_perfect, rssi):
    ...
    sigmoid = (1-failure_when_perfect)/(1+math.exp(-0.5*(62.5+rssi)))
    return sigmoid
...
def time_per_msg(time_per_try,num_tries):
	print('time per try: ', time_per_try,'num_tries: ',num_tries)
...
def guess_time_per():
	...
	return 300#need to measure this but this is approx correct
	#throttle+write_time
